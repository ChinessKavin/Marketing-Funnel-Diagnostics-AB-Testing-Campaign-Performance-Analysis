...
This README covers the highlights. A detailed walkthrough, the investigation step-by-step, the reasoning behind each decision, and the full segment results, is coming soon on Medium.
In the meantime, you can check out more of my writing here:

**[Medium Page](https://happinesskanife.medium.com/)**

## Files

- `Marketing Funnel Diagnostics. AB Testing & Campaign Performance Analysis .ipynb` - full notebook with code, charts, and analysis
